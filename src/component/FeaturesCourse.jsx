...
const FeaturesCourse = () => {
    const features = [
        ...
        },
        {
          ...
          icon: '../dist/images/money-bag.gif',
        },
        {
        ...
        },
        {
          ...
          icon: '../dist/images/cybersecurity.gif',
        },
        {
